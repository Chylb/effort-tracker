...
/**
Copy of AuthorizedClientServiceOAuth2AuthorizedClientManager that replaces anonymous Principal with Principal based on name of AuthorizedClient.
 */
public class PrincipalAgnosticAuthorizedClientServiceOAuth2AuthorizedClientManager implements OAuth2AuthorizedClientManager {
     ...
     */
    public PrincipalAgnosticAuthorizedClientServiceOAuth2AuthorizedClientManager(
    ...
    public OAuth2AuthorizedClient authorize(OAuth2AuthorizeRequest authorizeRequest) {
        ...
        if(principal.getClass() != OAuth2AuthenticationToken.class) {
            principal = new OAuth2AuthenticationToken(
                    new DefaultOAuth2User(List.of(), Map.of("id", authorizedClient.getPrincipalName()), "id"),
                    List.of(),
                    "strava");
        }
